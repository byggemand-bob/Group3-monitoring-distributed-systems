...
public class SQLMessageManager {
	...
	public static final String failed_message_table_name = "FailedMessages";
    ...
    public int Delete(String... whereArgs){
        final int removedRowCount = sqlManager.Delete(tableName, whereArgs);
